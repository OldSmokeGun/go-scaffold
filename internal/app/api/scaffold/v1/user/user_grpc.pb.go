...
func (c *userClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/internal.app.api.scaffold.v1.user.User/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) Update(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*UpdateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/internal.app.api.scaffold.v1.user.User/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/internal.app.api.scaffold.v1.user.User/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) Detail(ctx context.Context, in *DetailRequest, opts ...grpc.CallOption) (*DetailResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/internal.app.api.scaffold.v1.user.User/Detail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/internal.app.api.scaffold.v1.user.User/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _User_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/internal.app.api.scaffold.v1.user.User/Create",
	}
...
func _User_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/internal.app.api.scaffold.v1.user.User/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _User_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/internal.app.api.scaffold.v1.user.User/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _User_Detail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/internal.app.api.scaffold.v1.user.User/Detail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _User_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/internal.app.api.scaffold.v1.user.User/List",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var User_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "internal.app.api.scaffold.v1.user.User",
